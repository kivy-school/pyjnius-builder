...
class SignalThresholdInfo:
    ...
    class Builder:
        ...
        def setRadioAccessNetworkType(self, arg0: int) -> "Builder": ...
        def setSignalMeasurementType(self, arg0: int) -> "Builder": ...
        def setHysteresisDb(self, arg0: int) -> "Builder": ...
        def setThresholds(self, arg0: list[int]) -> "Builder": ...
