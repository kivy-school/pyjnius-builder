...
class ConcurrentSkipListSet(JavaClass, metaclass=MetaJavaClass):
    ...
    clone = JavaMethod("()Ljava/util/concurrent/ConcurrentSkipListSet;")
    size = JavaMethod("()I")
    ...
    subSet = JavaMultipleMethod([("(Ljava/lang/Object;ZLjava/lang/Object;Z)Ljava/util/NavigableSet;", False, False), ("(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/NavigableSet;", False, False)])
    headSet = JavaMultipleMethod([("(Ljava/lang/Object;Z)Ljava/util/NavigableSet;", False, False), ("(Ljava/lang/Object;)Ljava/util/NavigableSet;", False, False)])
    tailSet = JavaMultipleMethod([("(Ljava/lang/Object;Z)Ljava/util/NavigableSet;", False, False), ("(Ljava/lang/Object;)Ljava/util/NavigableSet;", False, False)])
