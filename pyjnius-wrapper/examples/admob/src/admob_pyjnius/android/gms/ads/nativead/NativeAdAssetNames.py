...
__all__ = ["NativeAdAssetNames"]

class NativeAdAssetNames(JavaClass, metaclass=MetaJavaClass):
    __javaclass__ = "com/google/android/gms/ads/nativead/NativeAdAssetNames"
