...
__all__ = ["RewardedAdPreloader"]

class RewardedAdPreloader(JavaClass, metaclass=MetaJavaClass):
    __javaclass__ = "com/google/android/gms/ads/rewarded/RewardedAdPreloader"
    ...
    pollAd = JavaStaticMethod("(Ljava/lang/String;)Lcom/google/android/gms/ads/rewarded/RewardedAd;")