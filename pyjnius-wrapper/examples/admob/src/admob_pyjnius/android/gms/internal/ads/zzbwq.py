...
class zzbwq(JavaClass, metaclass=MetaJavaClass):
    __javaclass__ = "com/google/android/gms/internal/ads/zzbwq"
    __javaconstructor__ = [("(Lcom/google/android/gms/ads/mediation/UnifiedNativeAdMapper;)V", False)]
